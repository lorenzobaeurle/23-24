...
# Erwartete Arbeitslosenquote bei einer Verschuldungsquote von 0%
expected_unemployment_at_zero_debt <- 6.895

# Ausgabe des Wertes
expected_unemployment_at_zero_debt
...
# Anwenden der Funktion coef auf reg1, um die geschätzten Koeffizienten zu erhalten
coefficients <- coef(reg1)

# Speichern des ersten Koeffizienten (Intercept) in der Variable b0
b0 <- coefficients[1]

# Speichern des zweiten Koeffizienten (Steigung von debt_share_country_pro) in der Variable b1
b1 <- coefficients[2]
