...
reg3 <- lm(depressed_1y ~ treat + depindex_0 + age_baseline + age_baseline_sq + kids_no + 
           famstruct_baseline + grandmother_baseline + edu_mo + edu_fa + employed_mo_baseline + 
           incomeindex + mspss_tot, data = thp)
